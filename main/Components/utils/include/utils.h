...
uint8_t getMostSignificantByte(uint16_t data);
void delay(const uint32_t& delay_ms);
uint16_t shift8BitTo16(const uint8_t& b1, const uint8_t& b2);
uint32_t shift8BitTo32(const uint8_t& b1, const uint8_t& b2, const uint8_t& b3, const uint8_t& b4);
bool shift32BitTo8(const uint32_t& b32, uint8_t& b1, uint8_t& b2, uint8_t& b3,
							uint8_t& b4);
