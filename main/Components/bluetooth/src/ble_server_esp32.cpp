...
#include "../include/ble_server_esp32.hpp"

//#define DEBUG // default uncommeted


static const char* LOG_TAG = "ble_server_esp32";
...
bool ble_server_esp32::setup_gap_default(const std::string &device_name)
{
    ESP_LOGI(LOG_TAG, "Setting up gap with default parameters");
   
    
    return m_gap.setup_gap_default(device_name);
}
