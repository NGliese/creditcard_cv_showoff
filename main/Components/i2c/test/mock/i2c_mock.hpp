...
class i2c_mock {
 ...
 public:
  ...
  bool readMultiBytes(const uint8_t& slave_address, uint8_t* data,
                      const size_t& length) {
 ...
 private:
  bool initialize_transaction() { return true; };
  bool execute_transaction() { return true; };
  bool insert_start_bit() { return true; };
  bool insert_stop_bit() { return true; };
};
