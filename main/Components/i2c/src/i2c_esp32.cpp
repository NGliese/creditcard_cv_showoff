...
bool i2c_esp32::writeMultiBytes(const uint8_t& slave_address, const uint8_t* data,
										 const size_t& length)
{
#ifdef DEBUG
...
bool i2c_esp32::readMultiBytes(const uint8_t& slave_address, const uint8_t& function_code,
...
bool i2c_esp32::insert_write_byte(const uint8_t& slave_address, const uint8_t& byte)
{
#ifdef DEBUG
...
bool i2c_esp32::insert_write_bytes(const uint8_t& slave_address, const uint8_t* bytes,
											const size_t& length)
{
#ifdef DEBUG
