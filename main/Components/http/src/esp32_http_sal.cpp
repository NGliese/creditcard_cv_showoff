...
esp_err_t esp32_http_sal::_http_event_handle(esp_http_client_event_t* evt)
{
	switch(evt->event_id)
	{
		case HTTP_EVENT_ERROR:
			std::cout << LOG_TAG << " HTTP_EVENT_ERROR\n";
			break;
		case HTTP_EVENT_ON_CONNECTED:
			std::cout << LOG_TAG << " HTTP_EVENT_ON_CONNECTED\n";
			break;
		case HTTP_EVENT_HEADER_SENT:
			std::cout << LOG_TAG << " HTTP_EVENT_HEADER_SENT\n";
			break;
		case HTTP_EVENT_ON_HEADER:
			std::cout << LOG_TAG << " HTTP_EVENT_ON_HEADER\n";
			printf("%.*s", evt->data_len, (char*)evt->data);
			break;
		case HTTP_EVENT_ON_DATA:
			std::cout << LOG_TAG << " HTTP_EVENT_ON_DATA, len=" << evt->data_len << "\n";
		...
		case HTTP_EVENT_ON_FINISH:
			std::cout << LOG_TAG << " HTTP_EVENT_ON_FINISH\n";

			break;
		case HTTP_EVENT_DISCONNECTED:
			std::cout << LOG_TAG << " HTTP_EVENT_DISCONNECTED\n";
			break;
		case HTTP_EVENT_REDIRECT:
			std::cout << LOG_TAG << " HTTP_EVENT_REDIRECT\n";
			break;
	}
	return ESP_OK;
}
...
bool esp32_http_sal::get(const std::string& api_call, std::string& output)
{
#ifdef DEBUG
...
bool esp32_http_sal::post(const std::string& api_call, const content_type& type,
